        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
                <c:forEach items="${ListaPersona}" var="dato">
                      <tr>
                        <td>${dato.idPago}</td>
                        <td>${dato.descuentos}</td>
                        <td>${dato.idMatricula}</td>
                        
                        
                        <td align="center">
                            <a href="${pageContext.request.contextPath}/elimper?id=${dato.idestudiante}" ><span title="Eliminar" class="glyphicon glyphicon-remove"></span></a>
                            <a href="${pageContext.request.contextPath}/formModif2Persona?id=${dato.idestudiante}" ><span title="Editar" class="glyphicon glyphicon-edit"></span></a>
